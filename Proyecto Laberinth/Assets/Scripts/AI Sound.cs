...
public class AIEnemy : MonoBehaviour
{
    ...
    {   
        ...
        if (distance <= noiseTravelDistance) 
        {
            ...
            {
                noisePosition = Playermove.playerPos;
                aiHeardPlayer = true;
    ...
    void ChasePlayer ()
    {
        ...
        {
            nav.SetDestination(Playermove.playerPos);
        }
    ...
    void FacePlayer()
    {
        Vector3 direction = (Playermove.playerPos - transform.position).normalized;
    ...
    void CheckLOS()
    {
        Vector3 direction = Playermove.playerPos - transform.position;
